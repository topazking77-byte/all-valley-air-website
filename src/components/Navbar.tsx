        ...
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
              className={`text-sm font-medium transition-colors hover:text-purple-500 ${isScrolled ? 'text-slate-600' : 'text-slate-200'
                }`}
            >
              {link.name}
            </a>
        ...
        >
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
              className="text-slate-600 font-medium py-2 hover:text-purple-500"
          ...
          <a href="tel:+14806166587" className="flex items-center gap-2 font-semibold text-slate-900 py-2">
            <Phone className="w-4 h-4 text-purple-500" />
            (480) 616-6587
          </a>
