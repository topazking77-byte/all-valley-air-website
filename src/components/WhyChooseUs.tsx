            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1">
                        <span className="text-purple-500 font-bold tracking-wider uppercase text-sm mb-2 block">Differentiators</span>
                        <h2 className="font-display font-bold text-4xl md:text-5xl text-slate-900 leading-tight mb-6">
                            Why Choose All Valley Air Inc.
                        </h2>
                        <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                            When you find yourself without heating or air conditioning, call our expert team at All Valley Air.
                            We don't just put a band-aid on it—we get to the root of the problem to ensure your comfort is restored quickly and reliably.
                        </p>
                    ...
                    >
                        <div className="absolute inset-0 bg-purple-100 rounded-3xl transform rotate-3 scale-105"></div>
                        <img
                        ...
                        <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl z-20 border border-slate-100">
                            <div className="text-4xl font-black text-purple-600 mb-1">20+</div>
