...
const services = [
  ...
  },
  {
    ...
    icon: ThermometerSnowflake,
    image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=2070&auto=format&fit=crop", // Re-using image for simplicity, ideally would find a unique one
  },
  {
    title: "Indoor Air Quality",
    description: "Breathe easier with advanced air filtration, purification, and duct cleaning services.",
    icon: Fan,
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop", // Re-using image for simplicity
  },
];
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            <span className="text-purple-500 font-bold tracking-wider uppercase text-sm mb-2 block">Our Expertise</span>
          ...
          <button className="hidden md:flex items-center gap-2 text-purple-600 font-bold hover:text-purple-700 transition-colors group">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <div className="flex items-center gap-2 text-purple-400 font-bold text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200">
        ...
        <div className="mt-12 text-center md:hidden">
          <button className="inline-flex items-center gap-2 text-purple-600 font-bold hover:text-purple-700 transition-colors">
