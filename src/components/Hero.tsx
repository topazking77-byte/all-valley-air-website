      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 text-sm font-medium text-purple-300 mb-6"
          >
          ...
          <h1 className="font-display font-bold text-5xl md:text-7xl text-white leading-[1.1] mb-6 tracking-tight">
            Cool Relief from the <span className="text-purple-400">Arizona Heat.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-purple-500 hover:bg-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-purple-500/20 flex items-center justify-center gap-2 group inline-flex cursor-pointer"
            >
              Schedule Service
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-transparent border border-white/30 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white/5 transition-colors flex items-center justify-center inline-flex cursor-pointer"
            >
              Get a Quote
            </motion.a>
          </div>
