        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-purple-500 hover:bg-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-purple-500/20 flex items-center justify-center gap-2 group"
            >
              Schedule Service
